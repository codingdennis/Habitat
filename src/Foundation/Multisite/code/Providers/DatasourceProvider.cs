namespace Sitecore.Foundation.Multisite.Providers
{
    ...
    public class DatasourceProvider : IDatasourceProvider
    {
        ...
        public Item[] GetDatasourceLocations(Item contextItem, string datasourceName)
        {
            ...
            var datasourceRoot = sourceSettingItem?[DatasourceConfigurationConstants.Fields.DatasourceLocation.ID];
        ...
        public Item GetDatasourceTemplate(Item contextItem, string settingName)
        {
            ...
            var templateId = settingItem?[DatasourceConfigurationConstants.Fields.DatasourceTemplate.ID];
