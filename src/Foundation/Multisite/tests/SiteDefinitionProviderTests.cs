namespace Sitecore.Foundation.Multisite.Tests
{
    ...
    public class SiteDefinitionProviderTests
    {
        ...
        {
            var siteRoot = new DbItem("siteRoot", ID.NewID, SiteConstants.TemplateID);
            db.Add(siteRoot);
            db.Add(contextItem);
        ...
        {
            var hierarchicalSiteRoot = new DbItem("siteRoot", ID.NewID, SiteConstants.TemplateID) {contextItem};
            ...
            var currentRoot = new DbItem("otherRoot", ID.NewID, SiteConstants.TemplateID);
            db.Add(currentRoot);
