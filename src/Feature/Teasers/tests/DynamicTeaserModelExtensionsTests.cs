namespace Sitecore.Feature.Teasers.Tests
{
    ...
    public class DynamicTeaserModelExtensionsTests
    {
        ...
        {
            //Arrange
            modelItem.Add(new DbItem("Inner item 1", new ID(), HeadlineConstants.TemplateID));
            modelItem.Add(new DbItem("Inner item 2", new ID(), HeadlineConstants.TemplateID));
            db.Add(modelItem);
        ...
        {
            //Arrange
            modelItem.Add(new DbItem("Inner item 1", new ID(), HeadlineConstants.TemplateID) { { TeaserContentConstants.Fields.TeaserImage.ID, $@"<image mediapath="""" src="""" height=""{maxHeight}"" mediaid="""" ></image>" } });
            modelItem.Add(new DbItem("Inner item 2", new ID(), HeadlineConstants.TemplateID) { { TeaserContentConstants.Fields.TeaserImage.ID, $@"<image mediapath="""" src="""" height=""{maxHeight - difference}"" mediaid="""" ></image>" } });
            db.Add(modelItem);
